...
```sh
git clone https://github.com/bkrisztian01/nvimrc.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/bkrisztian01/nvimrc.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/bkrisztian01/nvimrc.git "${env:LOCALAPPDATA}\nvim"
```
